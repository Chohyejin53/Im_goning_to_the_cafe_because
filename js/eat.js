    ...
    // 키워드로 장소를 검색합니다
    ps.keywordSearch('인천 베이커리 카페', placesSearchCB); 
    ps.keywordSearch('인천 디저트카페', placesSearchCB);
    ps.keywordSearch('인천 케이크 카페', placesSearchCB);
    ps.keywordSearch('인천 브런치 카페', placesSearchCB);
    ...
    function displayMarker(place) {
        var imageSrc = '../images/marker/cake_pin.png', // 마커이미지의 주소입니다    
